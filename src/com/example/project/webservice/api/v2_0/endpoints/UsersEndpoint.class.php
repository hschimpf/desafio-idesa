<?php
    ...
    use com\example\project\webservice\api\v1_0\endpoints\UsersEndpoint as UsersEndpoint_v1_0;

    class UsersEndpoint extends UsersEndpoint_v1_0 {
        ...
        public function post(string $verb = null, array $args = [], object $data = null, bool $local = false) {
            ...
            if ($verb !== null) {
                ...
                if (!isset($data->status) || strlen($data->status) == 0)        throw new Exception('User status not specified', 400);
                ...
                $pstmt->bindValue(':status',    $data->status);
        ...
        public function put(string $verb = null, array $args = [], object $data = null, bool $local = false) {
            ...
            if (isset($args[0])) {
                ...
                if (isset($data->status))   $update .= ($update == '' ? '' : ', ').' user_status = :status';
                // where id filter
                $update = '
                ...
                if (isset($data->status))   $pstmt->bindValue(':status',    $data->status);
